defmodule DojoWeb.CoreComponents do
  @moduledoc """
  ...
  def theme_toggle(assigns) do
    ~H"""
    <div class="relative flex flex-row items-center border-2 border-base-300 rounded-full">
      <div class="absolute w-1/2 h-full rounded-full bg-accent/50 left-0 [[data-theme=light]_&]:left-0 [[data-theme=dark]_&]:left-1/2 transition-[left]" />
      ...
      >
        <.icon
          ...
          class="size-4 opacity-75 hover:opacity-100 [[data-theme=dark]_&]:text-secondary-content [[data-theme=dark]_&]:drop-shadow-md [[data-theme=dark]_&]:drop-shadow-secondary-content"
        />
      </button>
    </div>
    """
