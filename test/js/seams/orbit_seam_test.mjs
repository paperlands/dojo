...
//
// DojoOrbitControls (assets/js/turtling/orbit.js) overrides and calls
// underscore-private members of the vendored OrbitControls. If an upgrade
// renames one, our override is simply never invoked and gesture arbitration
// stops SILENTLY — a pinch would start tilting again with nothing red anywhere.
//
...
// Members we call but do not override. These must still exist.
const CALLED = [
